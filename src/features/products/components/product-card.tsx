...
export function ProductCard({
  ...
  return (
    <article className="rounded-lg border border-border bg-surface p-4">
      ...
      <label className="mb-2 block min-w-0 text-[11px] text-muted">
      ...
      <div className="mt-4 flex flex-wrap items-center justify-end gap-2">
        <button
          ...
          onClick={onDelete}
          disabled={saving}
          className="inline-flex h-9 items-center rounded-md border border-danger/60 px-4 text-[12px] font-medium text-danger transition-colors hover:bg-danger-soft disabled:opacity-60"
        >
