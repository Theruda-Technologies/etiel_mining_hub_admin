    ...
    <article className="rounded-lg border border-border bg-surface p-4">
      ...
      <div className="mt-4 flex items-center justify-end gap-2">
        ...
        <button
          ...
          className={
            isDraft
              ? "inline-flex h-9 items-center rounded-md bg-accent px-4 text-[12px] font-semibold text-black transition-opacity hover:opacity-90"
              : "inline-flex h-9 items-center rounded-md border border-border px-4 text-[12px] font-medium text-foreground transition-colors hover:border-muted"
          }
        >
          {isDraft ? "Publish Changes" : "Save Changes"}
        </button>
      </div>
    </article>
  );
